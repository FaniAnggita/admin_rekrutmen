                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="lowongan.php" class="btn btn-danger btn-sm"> <i class="bx bx-left-arrow-alt"></i> Kembali</a>
                            </div>
                            ...
                            <div class="card-body">
                                <form id="tambah" method="post">
                                                ...
                                                <select id="kode_ps" class="form-select" name="kode_ps">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) { ?>
                                                            <option value="<?php echo $row['kode_ps']; ?>"><?php echo $row['nama_ps']; ?></option>
                                                    <?php }
                                                    } ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="penempatan">Penempatan</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i class="bx bx-current-location"></i></span>
                                                <input type="text" class="form-control" id="penempatan" name="penempatan" aria-label="John Doe" aria-describedby="penempatan" autocomplete="on" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="tenggat_daftar">Tenggat Pendaftaran</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
