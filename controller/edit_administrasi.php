...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $insertSql = "INSERT INTO seleksi_administrasi (id_pelamar, nilai_cv, nilai_kualifikasi, nilai_pengalaman, hasil_seleksi_adm, keterangan_adm)
                      VALUES ('$idPelamar', '$nilaiCV', '$nilaiKualifikasi', '$nilaiPengalaman', '$hasilSeleksiAdm', '$keteranganAdm')";
