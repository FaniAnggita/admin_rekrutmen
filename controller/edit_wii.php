...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $insertSql = "INSERT INTO seleksi_wii (id_pelamar, waktuInterview, konfirmasiKehadiran_wii, p, a, k, r, rating_wii, pengumuman_wii, interviewer_wii)
                      VALUES ('$idPelamar', '$waktuInterview', '$konfirmasiKehadiranWii', '$p', '$a', '$k', '$r', '$ratingWii', '$pengumumanWii', '$interviewerWii')";
